...
iex> import MinimalTodo  # that will import this file and you can run its functions direct

# before it you should type 
iex> MinimalTodo.start()

# after it you should type 
iex> start()

iex> r MinimalTodo  # to reload it
